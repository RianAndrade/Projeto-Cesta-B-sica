...
def tratamento_tabela(df):
    #Trocar os nomes das colunas e colocando o nome ign(ignorar) nas que devem ser removidas
    ...
    #Removendo as colunas que estão nomeadas com ign, e linha 0 do index para pois era um Ign
...
#chamada da função sub_produto
    ...
    df.index.set_levels(['marca', 'preço'], level=1, inplace=True)
